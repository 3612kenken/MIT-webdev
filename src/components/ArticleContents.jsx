...
function ArticleContents(){
    return (
        <>
        <div class="flex-article flex-article-center">
            <h2>Featured Stories</h2>
        </div>
        <div class='flex-article'>
            <div class="flex-article-left-margin">
                <h2>Bathala: The Creator God</h2>
                <p>In ancient Tagalog, the Supreme Being known as Bathala Maykapal, commonly known as Bathala, is regarded as the creator and ruler of the universe. This term was also used for lesser beings such as personal spirits, omen birds, comets, and other heavenly bodies.</p>
            </div>
            <div class="flex-article-right-margin ">
                <img class="rounded-img" src="./assets/images/Bathala.jpg" width={"100%"}/>
            </div>
        </div>
        <div class='flex-article'>
            <div class="flex-article-left-margin">
                <img class="rounded-img" src="./assets/images/Mythlok-Maria-Makiling-art-1024x907.jpg" width={"100%"}/>
            </div>
            <div class="flex-article-right-margin ">
            <h2>Maria Makiling: The Enigmatic Fairy</h2>
        ...
        <div class='flex-article flex-article-bottom'>
            ...
            <div class="flex-article-right-margin ">
                <img class="rounded-img" src="./assets/images/Mythlok-Aswang.jpg" width={"100%"}/>
